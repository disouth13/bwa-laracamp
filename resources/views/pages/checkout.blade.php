                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="item-bootcamp">
                            <img src="{{ asset('assets/frontend/images/item_bootcamp.png') }}" alt="" class="cover">
                            <h1 class="package">
                                GIAT BELAJAR
                            </h1>
                            <p class="description">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('success-checkout') }}" class="basic-form">
                            ...
                            <p class="text-center subheader mt-4">
                                <img src="{{ asset('assets/frontend/images/ic_secure.svg') }}" alt=""> Your payment is secure and encrypted.
                            </p>
                        </form>
                    </div>
                </div>
